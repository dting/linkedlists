describe("SinglyLinkedList", function() {
  ...
  describe('when created', function() {
    ...
    it("should have head equal null", function() {
      list = new SinglyLinkedList();
  ...
  describe("#unshift", function() {
    describe('given an empty list', function() {
      ...
      it('should set head to new node with element', function() {
        list.unshift(1);
    ...
    describe('given a list with a single node', function() {
      beforeEach(function() {
        list = makeSinglyLinkedListOf(1);
      });

      it('should add node with element to front', function() {
        list.unshift(2);
        assertSinglyLinkedList(list, 2, 1);
      });
    ...
    describe('given a list with multiple nodes', function() {
      beforeEach(function() {
        list = makeSinglyLinkedListOf(1, 2, 3);
      });

      it('should add node with element to front', function() {
        list.unshift(4);
        assertSinglyLinkedList(list, 4, 1, 2, 3);
      });
  ...
  describe("#push", function() {
    ...
    describe('given a list with a single node', function() {
      ...
      it('should add node with element to end', function() {
        list.push(2);
        assertSinglyLinkedList(list, 1, 2);
      });
    ...
    describe('given a list with multiple nodes', function() {
      ...
      it('should add node with element to end', function() {
        list.push(4);
        assertSinglyLinkedList(list, 1, 2, 3, 4);
      });
  ...
  describe("#insert", function() {
    ...
    describe('given a list with multiple nodes', function() {
      ...
      describe('when inserting at the beginning', function() {
      ...
      describe('when inserting in the middle ', function() {
        ...
        it("should insert element in list at index", function() {
          list.insert(1, 4);
          assertSinglyLinkedList(list, 1, 4, 2, 3);
        });
  ...
  describe("#indexOf", function() {
    ...
    describe('given a list with duplicates', function() {
      beforeEach(function() {
        list = makeSinglyLinkedListOf(1, 1, 2, 3, 2);
      });
  ...
  describe("#shift", function() {
    ...
    describe('given a list with multiple nodes', function() {
      ...
      it("should remove the first node and return element", function() {
        expect(list.shift()).toBe(1);
        assertSinglyLinkedList(list, 2, 3);
      });
  ...
  describe("#removeAt", function() {
    ...
    describe('given a list with multiple nodes', function() {
      ...
      describe('when removing first element', function() {
      ...
      describe('when removing from middle', function() {
        ...
        it("should remove node and return element", function() {
          ...
          assertSinglyLinkedList(list, 1, 3);
        });
  ...
  describe("#remove", function() {
    ...
    describe('given a list with multiple nodes', function() {
      ...
      it("should return false for any element not in list", function() {
        ...
        expect(list.remove(null)).toBe(false);
        expect(list.remove("hello")).toBe(false);
        assertSinglyLinkedList(list, 1, 2, 3);
      });
      ...
      describe('when removing from beginning', function() {
        it("should change head to second node", function() {
          var originalHead = list.head;
          list.remove(1);
          expect(list.head).toBe(originalHead.next);
    ...
    describe('given a list with duplicates', function() {
      ...
      it("should remove only the first occurrence and return true", function() {
        expect(list.remove(1)).toBe(true);
        assertSinglyLinkedList(list, 1, 2, 3, 2);
      });
    });
  });
});

function makeSinglyLinkedListOf(...elements) {
...
function assertSinglyLinkedList(list, ...elements) {
